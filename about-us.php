                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="text">
                                            ...
                                            <div class="iq_heading_1 text-left">
                                                <h4>Welcome to <span>Living TV Film Academy</span></h4>
                                            </div>
                                            <!--Heading Wrap End-->
                                            ...
                                            <div class="feature-box">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="feature-content">
                                                        <h4 class="aboutus-title">OUR AIMS AND OBJECTIVES</h4>
                                                        <p>To develop the youth particularly those desiring to be proficient in film and mass communication for a sustainable life style.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="feature-box">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="feature-content">
                                                        <h4 class="aboutus-title">OUR VISION</h4>
                                                        <p>To strengthen the youth as basis for strong, virile and indivisible nation through skill, discipline and educational development.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="feature-box">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="feature-content">
                                                        <h4 class="aboutus-title">OUR MISSION</h4>
                        ...
                        <section>
                            <div class="container">
                                ...
                                <div class="iq_heading_1 text-center">
                                    <h4>TEAM <span>MANAGEMENT</span></h4>
