...
?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="course-content">
                            <h4>Journalism & Media Studies</h4>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="course-content">
                            <h4>Information & Media Studies</h4>
    ...
    <div class="testimonials-area section-padding-100 bg-img bg-overlay" style="background-image: url(assets/img/bg-img/bg-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto white wow fadeInUp" data-wow-delay="300ms">
                        <span>HANDS-ON FILM & ACTING SCHOOL</span>
                        <h4><span>Each student writes, shoots, directs and edits 8 films and works on crew of 28 more in the first year!</span></h4>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        <div class="popular-course-content">
                            <h5>Journalism & Media Studies</h5>
                            <span>By Living TV   |  March 18, 2018</span>
                            ...
                            <ul>
                                <li style="list-style-type: circle;">Broadcast Journalism</li>
                                <li style="list-style-type: circle;">TV Presentations</li>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <div class="popular-course-content">
                            <h5>Information & Media Studies</h5>
                            <span>By Living TV  |  March 18, 2018</span>
                            <div class="course-ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                        <div class="popular-course-content">
                            <h5>Film & Multilmedia Studies</h5>
                            <span>By Living TV   |  March 18, 2018</span>
                            <div class="course-ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                            ...
                            <ul>
                                <li style="list-style-type: circle;">Cinematography</li>
                                <li style="list-style-type: circle;">Acting</li>
                                <li style="list-style-type: circle;">Video Editing Producing</li>
                    ...
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                        <div class="popular-course-content">
                            ...
                            <ul>
                                ...
                                <li style="list-style-type: circle;">Journalism</li>
                                <li style="list-style-type: circle;">Photo Journalism</li>
